                ...
                if (cards.length === 0) {
                    ...
                    $.each(cards, function (index, card) {
                        ...
                        let cardContent = `
                            ...
                            <label for="card-title">Тип услуги: <p class="cardText">${card.title}</p></label>
                            <label for="card-title">Дата бронирования: <p class="cardText">${card.data}</p></label>
                            <label for="card-title">Время бронирования: <p class="cardText">${card.time}</p></label>
                            <label for="card-title">Количество игроков <p class="cardText">${card.number}</p></label>
                            <label for="card-title">Тип оплаты <p class="cardText">${card.money}</p></label>
                        ...
                        if (currentUser.username === 'admin') {
                            ...
                            const statuses = ['новая', 'принята', 'откланина'];
